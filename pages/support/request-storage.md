...
We also encourage SCINet users to make use of temporary storage space in `/90daydata`, which has no quota limits and is ideal for working with large data files and intermediate results.
